...
final class GenScavengeAllocationSnippets extends SubstrateAllocationSnippets {
    ...
    public Object allocateStoredContinuationInstance(@ConstantParameter DynamicHub hub, int payloadSize, @ConstantParameter DynamicHub byteArrayHub,
        ...
        Object result = allocateArrayImpl(encodeAsTLABObjectHeader(byteArrayHub), WordFactory.zero(), arrayLength, byteArrayBaseOffset, 0, FillContent.WITH_GARBAGE_IF_ASSERTIONS_ENABLED,
        ...
        initializeObjectHeader(Word.objectToUntrackedPointer(result), header, WordFactory.zero(), false);
