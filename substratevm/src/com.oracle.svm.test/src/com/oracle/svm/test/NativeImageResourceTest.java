...
public class NativeImageResourceTest {
    ...
    public void classGetDirectoryResource() {
        ...
        String canonicalResourceDirectoryName = RESOURCE_DIR + "/./";
        url2 = resourceNameToURL(canonicalResourceDirectoryName, false);
        Assert.assertNull("Resource " + canonicalResourceDirectoryName + " is found!", url2);
    }
}
